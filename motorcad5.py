...
from minitabexecute import dirgenerate, setdata, rownumbermax, rownumber, quickedit, fulldatanam, quickcalcheckstr, \
    ...
    write_data_to_excelholexc, rownumbersthreerounbo, quickdatanam, turnscaccheckstr, turnscachigeffcheckstr
from motorcadinputdata import wirediametcal, drawstatot, openmcad, drawstatotroundbo, fakeslotdepth, close_instances
...
def maincal():
    ...
    if rownumberture != 0:
        ...
        if turnscaccheck == 2 or turnscaccheck == 1 or turnscachigeffcheck == 4:
            close_instances(MotorCAD_File5, mcad)
        setdata(minitbookaddr_, sequence + 21, 9, 1)
    loggenera('turnscaccheck' + str(turnscaccheck))
    loggenera('turnscachigeffcheck' + str(turnscachigeffcheck))
